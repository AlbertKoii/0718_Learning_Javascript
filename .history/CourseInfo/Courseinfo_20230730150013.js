...
let lindyHop = document.getElementsByClassName('classroomLh');
let charleston = document.getElementsByClassName('classroomCh');
let bachata = document.getElementsByClassName('classroomBa');
let salsa = document.getElementsByClassName('classroomSa');
